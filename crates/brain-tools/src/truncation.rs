...
mod tests {
    ...
    #[test]
    fn truncate_middle_adds_notice() {
        let truncated =
            truncate_middle_with_notice("abcdefghijklmnopqrstuvwxyz", 18, "shell output");
        assert!(truncated.contains("shell output truncated"));
    }

    #[test]
    fn truncate_line_shortens_long_line() {
        let truncated = truncate_line("abcdefghijklmnopqrstuvwxyz", 10);
