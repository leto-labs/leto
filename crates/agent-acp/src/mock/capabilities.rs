...
pub(super) const MODEL_FAST: &str = "agent-mock-fast";
#[cfg(feature = "unstable_session_model")]
pub(super) const MODEL_DEEP: &str = "agent-mock-deep";
...
pub(super) fn model_state(session: &MockSession) -> acp::SessionModelState {
    acp::SessionModelState::new(
        ...
        vec![
            acp::ModelInfo::new(MODEL_FAST, "Agent Mock Fast")
                .description("Fast mock model optimized for simple echo replies."),
            acp::ModelInfo::new(MODEL_DEEP, "Agent Mock Deep")
