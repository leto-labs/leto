...
2. A future remote implementation, conceptually `BrainRuntimeApi`, will also
...
4. A future `brain-server` will host the native runtime and expose the transport
   needed by the remote runtime client.
