...
## Note
This delta captures a planned interruption model for the abandoned in-repo TUI
direction. It is archived as superseded and is not promoted into canonical
specs from this change.
